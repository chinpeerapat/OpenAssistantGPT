...
<body>
  <iframe src="${siteConfig.url}embed/${params.chatbotId}/button?chatbox=false"
    ...
    id="filmtheory-chatbot-button-iframe"></iframe>
  <iframe src="${siteConfig.url}embed/${params.chatbotId}/window?chatbox=false&withExitX=true"
    ...
    allowfullscreen id="filmtheory-chatbot-iframe"></iframe>
</body>
`}>
                        </CodeBlock>
                        <CodeBlock
    ...
    return (
      ...
      \`}} />
            <iframe
                ...
                scrolling='no'
                id="filmtheory-chatbot-button-iframe"
