  ...
  return (
    <DashboardShell>
      ...
      <div className="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4" role="alert">
        ...
        <p className="text-sm">The crawlers don&apos;t support website generated with javascript at runtime yet. If your website isn’t SSR or static we won&apos;t be able to fetch the content.</p>
